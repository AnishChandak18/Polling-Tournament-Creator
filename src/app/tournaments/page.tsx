...
export default async function TournamentsPage() {
  ...
  return (
    <PageShell active="circles" maxWidth="max-w-7xl" className="space-y-8 px-4" rightSlot={<PointsChip points={totalPoints} />}>
      <header className="space-y-1">
        <h1 className="font-display text-4xl font-black uppercase tracking-tighter text-on-surface">Circles</h1>
      ...
      <div className="flex flex-col gap-6 lg:grid lg:grid-cols-12 lg:gap-6">
        <div className="flex flex-col gap-6 lg:col-span-5">
          ...
          >
            ...
            <div className="relative z-10 flex items-center gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-on-primary-container/10">
                <span className="material-symbols-outlined text-2xl text-on-primary-container">group_add</span>
              </div>
              <div>
                ...
                <div className="mt-1 flex items-center gap-2">
                  <p className="text-xs font-bold uppercase tracking-widest text-on-primary-container/80">Create New Group</p>
                  <span className="material-symbols-outlined text-sm text-on-primary-container">arrow_forward</span>
                </div>
              </div>
            </div>
          </Link>
          ...
          <div className="relative rounded-xl border border-zinc-800 bg-surface-container p-6 after:absolute after:bottom-0 after:right-0 after:h-5 after:w-5 after:border-b-2 after:border-r-2 after:border-primary after:content-['']">
            <p className="mb-4 font-display text-xs font-bold uppercase tracking-[0.2em] text-zinc-500">Join with Circle ID</p>
            <p className="text-sm text-on-surface-variant">
              Enter your invite code on the join screen — open the tactical join flow.
            </p>
            <Link
              href="/join"
        ...
        <div className="lg:col-span-7">
          <div className="flex h-full flex-col overflow-hidden rounded-xl border border-zinc-800 bg-surface-container-low p-6">
            <div className="mb-8 flex items-center justify-between">
              <div>
                <h3 className="font-display text-2xl font-black uppercase tracking-tighter text-on-surface">Your Circles</h3>
                <p className="text-xs font-bold uppercase tracking-widest text-zinc-500">Your Active Groups</p>
              </div>
              <span className="rounded bg-primary/10 px-2 py-0.5 text-xs font-bold text-primary">{activeCount} Active</span>
            </div>
                  ...
                  >
                    <div className="flex min-w-0 flex-1 items-center gap-4">
                      ...
                      <div className="min-w-0">
                        <p className="font-display text-xl font-black text-on-surface">{t.name}</p>
